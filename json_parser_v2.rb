...
def parse_object(tokens) 
	if tokens[0] == '{'
		...
		while tokens[0] != nil
			...
			tokens.shift()
			func = parser_factory(method(:parse_object), method(:parse_array), method(:parse_string), method(:parse_number), method(:parse_true_false))
			value, tokens = func.call(tokens)
